...
// TestParseArguments проверяет поддерживаемые аргументы и ошибки запуска.
...
// TestRunRejectsArgumentsBeforeAccessingPath проверяет ранний отказ до работы с путём.
...
// TestRunEmptyDirectory проверяет успешный итог при отсутствии входных файлов.
...
// assertDepth сравнивает два необязательных ограничения глубины.
